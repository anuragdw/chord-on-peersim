 ...
 * 
 */
public class ObserverN implements Control {
	 ...
	 * 
	 */
	public ObserverN(String prefix) {
		this.prefix = prefix;
	...
	public boolean execute() {
		...
		/*	if (media > 0)
			...
			if (hopCC == 0) hopCC = 1; 
			if ( CommonState.getTime() >= 5000 ) System.out.println(CommonState.getTime() - 5000  + " " + count +  " " + size + " " + latestValue + " " + hopCC + " " + (float)hopCount/hopCC );
